...
| session_liquidity_sweep_reversal | liquidity pattern | not_started | docs/strategy_session_liquidity_sweep_reversal.md | outputs/session_liquidity_sweep_reversal_diagnostic/ | not_started |
...
| break_retest_continuation | market structure | not_started | docs/strategy_break_retest_continuation.md | outputs/break_retest_continuation_diagnostic/ | not_started |
| vwap_band_reversion_filtered | intraday mean reversion | not_started | docs/strategy_vwap_band_reversion_filtered.md | outputs/vwap_band_reversion_filtered_diagnostic/ | not_started |
| session_breakout_continuation | momentum | not_started | docs/strategy_session_breakout_continuation.md | outputs/session_breakout_continuation_diagnostic/ | not_started |
