...
- [Impulse session-open summary (MVP tested, rejected)](docs/strategy_impulse_session_open.md)
- [ATR spike + new high/low summary (MVP tested, rejected)](docs/strategy_atr_spike_new_high_low.md)
- [VWAP session-open reversion summary (MVP tested, rejected)](docs/strategy_vwap_session_open.md)
...
- `impulse_session_open` (MVP tested, rejected in current form)
- `atr_spike_new_high_low` (MVP tested, rejected in current form)
- `vwap_session_open` (MVP tested, rejected in current form)
